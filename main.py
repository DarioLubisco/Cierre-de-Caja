...
app = FastAPI(title="Cuadre de Cajas API", version="1.0.0")
...
@app.get("/caja/reportes/detalle/{cierre_id}")
...
@app.get("/caja/admin/resumen_diario")
...
@app.post("/caja/calculadora/guardar")
...
@app.get("/caja/reportes/{cierre_id}/pdf")
